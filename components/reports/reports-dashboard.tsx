...
import { ReportWithTemplate, ReportStatus } from '@/lib/types/reports';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{Math.round(stats.avgViews)}</div>
          </CardContent>
        </Card>
      </div>
                ...
                <div className="flex items-start justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={() => router.push(`/reports/builder?edit=${report.id}`)}>
