...
const TEMPLATE_CATEGORIES: TemplateCategory[] = [
  ...
  },
  {
    id: "operational",
    name: "Operational",
    description: "Operations and process reports",
    icon: "line-chart",
    count: 0,
  },
  {
    id: "marketing",
    name: "Marketing",
    description: "Marketing and campaign reports",
    icon: "trending-up",
    count: 0,
  },
  {
...
export function TemplateGallery({
  ...
  const [categories, setCategories] =
    useState<TemplateCategory[]>(TEMPLATE_CATEGORIES);
    ...
    const mockTemplates: Template[] = [
      {
        ...
        description:
          "Comprehensive sales performance tracking with key metrics, trends, and regional breakdowns.",
        category: "analytics",
      ...
      },
      {
        ...
        description:
          "Executive-level financial overview with P&L, cash flow, and budget variance analysis.",
        category: "financial",
      ...
      },
      {
        ...
        description:
          "Monitor operational KPIs, process efficiency, and resource utilization metrics.",
      ...
      },
      {
        ...
        description:
          "Track campaign performance, ROI, conversion rates, and audience engagement metrics.",
        category: "marketing",
      ...
      },
      {
        ...
        description:
          "Project milestone tracking with timeline, resource allocation, and risk assessment.",
        category: "custom",
