...
export const metadata: Metadata = {
  ...
  description: 'Configure report permissions, user roles, export settings, and data sources',
};
    ...
    <div className="container mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Manage permissions, user roles, export configurations, and data sources
        </p>
      </div>

      <Suspense fallback={<ReportSettingsSkeleton />}>
        <ReportSettings userId={userId} />
      </Suspense>
    </div>
  );
}