  ...
  const fetchNotifications = useCallback(
    async (
      ...
      try {
        ...
        logger.error("Error fetching notifications", "useNotifications", error);
  ...
  const deleteNotification = useCallback(
    async (notificationId: string) => {
      try {
        ...
        logger.error("Error deleting notification", "useNotifications", error);
  ...
  const createNotification = useCallback(
    async (notification: {
      ...
      try {
        ...
        logger.error("Error creating notification", "useNotifications", error);
  ...
  const connect = useCallback(() => {
    ...
    try {
      ...
      eventSource.onerror = (error) => {
        logger.error("SSE error", "useRealtimeNotifications", error);
        setConnected(false);
